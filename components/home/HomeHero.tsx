    ...
    <section className="bg-gradient-to-br from-stone-900 via-teal-900 to-stone-800 text-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <p
          lang="ar"
          dir="rtl"
          className={`${indoPakArabic.className} indo-pak-arabic text-2xl leading-relaxed text-white sm:text-3xl`}
        >
          {bismillahArabic}
        </p>
        <p className="mt-2 max-w-xl text-sm italic text-white/80 sm:text-base">{bismillahEnglish}</p>
        <h1 className="mt-6 text-3xl font-bold text-gold-light sm:text-4xl">Darse Quran Academy</h1>
